...
/*
    如果需要设置可选协议方法
    0 需要准守 NSObjectProtocol
    1 协议需要时 @objc的
    2 方法是 @objc optional
 */
@objc protocol CellProtoucalDelegate: NSObjectProtocol {
    //可选协议
  @objc optional func didSelectedUrlString(cell: HomeStatusCell, string: String?)
...
class HomeStatusCell: UITableViewCell {
    ...
    //协议代理属性写法
    weak var delegate: CellProtoucalDelegate?
    ...
    @IBOutlet weak var contentLabel: FFLabel! // 正文
    ...
    @IBOutlet weak var retweetedTextLabel: FFLabel?
    // MARK:- 分享
...
// MARK:- 点击cell链接 实现协议代理方法
extension HomeStatusCell: FFLabelDelegate{
    ...
    func labelDidSelectedLinkText(label: FFLabel, text: String) {
        ...
        //可选协议方法 需要 didSelectedUrlString?
        delegate?.didSelectedUrlString?(cell: self, string: text)
